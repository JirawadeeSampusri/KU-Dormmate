        ...
        <div className="bg-white shadow rounded laptop:w-1/3 tablet:w-1/2 w-full p-10 mt-6">
          ...
          <form onSubmit={logIn}>
            ...
            <div className="mt-8">
              <button
                type="submit"
                className="focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 text-sm font-semibold leading-none text-white focus:outline-none bg-cyan-600 border rounded hover:bg-cyan-500 py-4 w-full"
              >
                Sign In
              </button>
            </div>
