    ...
    const logIn = async (event) => {
      ...
      try {
        if (firebaseInstance) {
          ...
          alert("Welcome back!");
          window.location.replace("/landing_owner")
        }
      } catch (error) {
        ...
        {/* <!--- more free and premium Tailwind CSS components at https://tailwinduikit.com/ ---> */}
            ...
            <div class="flex flex-col items-center justify-center">
                ...
                <div class="bg-white shadow rounded laptop:w-1/3 tablet:w-1/2 w-full p-10 mt-6">
                    ...
                    <p tabindex="0" class="focus:outline-none text-sm mt-4 font-medium leading-none text-gray-500">Don't have account? 
                    <a href="./register_owner"   class="hover:text-gray-500 focus:text-gray-500 focus:outline-none focus:underline hover:underline text-sm font-medium leading-none  text-gray-800 cursor-pointer"> Sign Up as Owner</a></p>
                    ...
                    <button onClick={facebookSignIn} aria-label="Continue with github" class="focus:outline-none  focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 py-3.5 px-4 border rounded-lg border-gray-700 flex items-center w-full mt-4">
                    ...
                    <form onSubmit={logIn}>
                        <div>
                            ...
                            <input aria-labelledby="email" type="email" class="bg-gray-200 border rounded  text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2" {...email}/>
                        </div>
                        ...
                        <div class="mt-8">
                            <button type="submit" class="focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 text-sm font-semibold leading-none text-white focus:outline-none bg-cyan-600 border rounded hover:bg-cyan-500 py-4 w-full">Sign In</button>
                        </div>
                    </form>
                </div>
            </div>
