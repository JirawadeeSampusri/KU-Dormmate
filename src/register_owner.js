...
const Register_Owner = () => {
  ...
  return (
    <div className="h-full bg-gradient-to-tl from-zinc-300 to-zinc-900 w-full py-16 px-4">
      ...
      <div className="flex flex-col items-center justify-center">
        ...
        <div className="bg-white shadow rounded laptop:w-1/3 tablet:w-1/2 w-full p-10 mt-6">
          <p
            tabIndex="0"
          ...
          >
            ...
            <p className="text-base font-medium ml-3 text-gray-700">
          ...
          <form>
            {/* <div>
                            ...
                            <input id="username" aria-labelledby="username" type="username" className="bg-gray-200 border rounded  text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2"{...email}/>
                        </div> */}
            ...
            {/* <div className="mt-6  w-full">
                            <label for="tel" className="text-sm font-medium leading-none text-gray-800">
                                Tel
                            </label>
                           <div className="relative flex items-center justify-center">
                            <input id="tel" type="tel" className="bg-gray-200 border rounded  text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2" {...tel}/>
            ...
            {/* <div className="mt-6  w-full">
                           ...
                           <div className="relative flex items-center justify-center">
                            <input id="pass" type="confirm_password" className="bg-gray-200 border rounded  text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2" {...password}/>
                            <div className="absolute right-0 mt-2 mr-3 cursor-pointer">
            ...
            <div className="mt-8">
              <button className="focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 text-sm font-semibold leading-none text-white focus:outline-none bg-cyan-600 border rounded hover:bg-cyan-500 py-4 w-full">
                Regis
              </button>
            </div>
          </form>
