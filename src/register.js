            ...
            <div class="flex flex-col items-center justify-center">
                ...
                <div class="bg-white shadow rounded laptop:w-1/3 tablet:w-1/2 w-full p-10 mt-8">
                    ...
                    <div class="w-full flex items-center justify-between py-5">
                        ...
                        <div class="mt-8">
                            <button role="button" class="focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 text-sm font-semibold leading-none text-white focus:outline-none bg-cyan-600 border rounded hover:bg-cyan-500 py-4 w-full">Regis</button>
                        </div>
                </div>
            </div>
        </div>
