...
<div class="2xl:mx-auto 2xl:container laptop:px-20 laptop:py-16 tablet:py-12 tablet:px-6 py-9 px-4 w-96 tablet:w-auto">
  <div role="main" class="flex flex-col items-center justify-center ">
    <h1 class="text-4xl font-semibold leading-9 text-center text-teal-600">This Week Blogs</h1>
    <p class="text-base leading-normal text-center  mt-4 laptop:w-1/2 tablet:w-10/12 w-11/12">If you're looking for random paragraphs, you've come to the right place. When a random word or a random sentence isn't quite enough</p>
  </div>
