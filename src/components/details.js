    ...
    <div className="bg-gray-50">
      <div className="pt-6">
        ...
        {/* <nav aria-label="Breadcrumb">
              <ol role="list" className="max-w-2xl mx-auto px-4 flex items-center space-x-2 sm:px-6 laptop:max-w-7xl laptop:px-8">
                <li>
        ...
        {/* <!-- Product info --> */}
        <div className="max-w-2xl mx-auto pt-10 pb-16 px-4 sm:px-6 laptop:max-w-7xl laptop:pt-16 laptop:pb-24 laptop:px-8 laptop:grid laptop:grid-cols-3 laptop:grid-rows-[auto,auto,1fr] laptop:gap-x-8">
          ...
          <div className="mt-4 laptop:mt-0 laptop:row-span-3">
            ...
            <p className="text-3xl text-gray-900">6000 Baht</p>
            ...
            <form className="mt-10">
                ...
                <fieldset className="mt-4">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <label className="-m-0.5 relative p-0.5 rounded-full flex items-center justify-center cursor-pointer focus:outline-none ring-gray-400">
                      ...
                      <span
                        aria-hidden="true"
                        className="h-8 w-8 bg-gray-50 border border-black border-opacity-10 rounded-full"
                      ></span>
                    </label>
                    {/*         
                        <!--
              ...
              <div className="mt-10">
                ...
                <fieldset className="mt-4">
                  ...
                  <div className="grid grid-cols-4 gap-4 sm:grid-cols-8 laptop:grid-cols-4">
                    ...
                    {/* <!-- Active: "ring-2 ring-indigo-500" --> */}
                    <label className="group relative border rounded-md py-3 px-4 flex items-center justify-center text-sm font-medium uppercase hover:bg-gray-50 focus:outline-none sm:flex-1 sm:py-6 bg-gray-50 shadow-sm text-gray-900 cursor-pointer">
                      <input
                        type="radio"
                        name="size-choice"
                        value="XS"
