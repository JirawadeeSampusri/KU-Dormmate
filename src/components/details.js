        ...
        <div class="bg-gray-50">
          <div class="pt-6">
            ...
            <div class="max-w-2xl mx-auto pt-10 pb-16 px-4 sm:px-6 laptop:max-w-7xl laptop:pt-16 laptop:pb-24 laptop:px-8 laptop:grid laptop:grid-cols-3 laptop:grid-rows-[auto,auto,1fr] laptop:gap-x-8">
              <div class="laptop:col-span-2 laptop:border-r laptop:border-gray-200 laptop:pr-8">
                    ...
                    <fieldset class="mt-4">
                      ...
                      <div class="flex items-center space-x-3">
                        ...
                        <label class="-m-0.5 relative p-0.5 rounded-full flex items-center justify-center cursor-pointer focus:outline-none ring-gray-400">
                          ...
                          <span aria-hidden="true" class="h-8 w-8 bg-gray-50 border border-black border-opacity-10 rounded-full"></span>
                        </label>
{/*         
                        <!--
                          Active and Checked: "ring ring-offset-1"
                  ...
                  <div class="mt-10">
                    ...
                    <fieldset class="mt-4">
                      ...
                      <div class="grid grid-cols-4 gap-4 sm:grid-cols-8 laptop:grid-cols-4">
                        ...
                        {/* <!-- Active: "ring-2 ring-indigo-500" --> */}
                        <label class="group relative border rounded-md py-3 px-4 flex items-center justify-center text-sm font-medium uppercase hover:bg-gray-50 focus:outline-none sm:flex-1 sm:py-6 bg-gray-50 shadow-sm text-gray-900 cursor-pointer">
...
{/*         
              ...
              <div class="py-10 laptop:pt-6 laptop:pb-16 laptop:col-start-1 laptop:col-span-2 laptop:border-r laptop:border-gray-200 laptop:pr-8">
